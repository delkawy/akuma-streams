import { fetchText, postForm, headRequest, rangeProbe, DEFAULT_UA } from '../utils/http.js';
...
export { BASE, DEFAULT_UA, get, postAjax, getCached, headRequest, rangeProbe, buildCookieHeader, withAgeCookie };
export default { get, postAjax, getCached, headRequest, rangeProbe, BASE, DEFAULT_UA, buildCookieHeader };
